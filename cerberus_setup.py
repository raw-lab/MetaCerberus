...
def install_dependencies():
    conda_cmd = "conda create -n cerberus -c conda-forge -c bioconda hmmer prodigal fastqc fastp porechop bbmap pandas numpy plotly openpyxl matplotlib scikit-learn python=3.7 -y"
