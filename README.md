...
GAGE is recommended for pathway enrichment followed by PathView for visualize the metabolic pathways. A "class" file is required through the --class option to run this analysis. The class file is a list of samples in one column and class column grouped by the comparison that you want to make. 
For example rhizobium vs. not:
sample  class
1A      rhizobium
1B      non-rhizobium
